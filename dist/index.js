...
/* harmony export */   PNDMScheduler: () => (/* binding */ PNDMScheduler)
/* harmony export */ });
/* harmony import */ var onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! onnxruntime-web/webgpu */ "./node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs?79d7");
// PNDMScheduler.js
...
class PNDMScheduler {
  ...
  _step_plms(model_output, timestep, sample) {
    ...
    if (this.ets.length === 1 && this.counter === 0) {
      ...
      model_output = new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor("float32", out, model_output.dims);
  ...
  _get_prev_sample(sample, timestep, prev_timestep, model_output) {
    ...
    return new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor("float32", out, sample.dims);
  }

  _cloneTensor(t) {
    const data = new Float32Array(t.data.length);
    data.set(t.data);
    return new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor("float32", data, t.dims.slice());
  }
}
...
module.exports = __webpack_require__.p + "aa2a6c407dffa367d229.wasm";
...
module.exports = __webpack_require__.p + "7fd6f237f2818b16070c.mjs";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   InferenceSession: () => (/* binding */ xu),
/* harmony export */   TRACE: () => (/* binding */ uo),
/* harmony export */   TRACE_EVENT_BEGIN: () => (/* binding */ Ye),
/* harmony export */   TRACE_EVENT_END: () => (/* binding */ qe),
/* harmony export */   TRACE_FUNC_BEGIN: () => (/* binding */ nt),
/* harmony export */   TRACE_FUNC_END: () => (/* binding */ it),
/* harmony export */   Tensor: () => (/* binding */ Oe),
/* harmony export */   "default": () => (/* binding */ Kl),
/* harmony export */   env: () => (/* binding */ X),
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! onnxruntime-web/webgpu */ "./node_modules/onnxruntime-web/dist/ort.webgpu.bundle.min.mjs?79d7");
/* harmony import */ var _PNDMScheduler_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PNDMScheduler.js */ "./PNDMScheduler.js");
    ...
    for (const [name, model] of Object.entries(models)) {
        try {
            ...
            if (model.external) {
                ...
                models[name].sess = await onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].InferenceSession.create(modelUrl, sess_opt);
            } else {
                const model_bytes = await fetchAndCache(config.model, model.url);
                models[name].sess = await onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].InferenceSession.create(model_bytes, sess_opt);
            }
...
onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].env.wasm.wasmPaths = 'https://cdn.jsdelivr.net/npm/onnxruntime-web@latest/dist/';
onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].env.wasm.numThreads = 1;
onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].env.wasm.simd = true;
...
const scheduler = new _PNDMScheduler_js__WEBPACK_IMPORTED_MODULE_1__.PNDMScheduler({
...
async function draw_image(t, image_nr) {
    ...
    const tmpTensor = new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor('float32', pix, t.dims);
...
async function generate_image() {
    try {
        ...
        const condOut = await models.text_encoder.sess.run({
            "input_ids": new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor("int64", input_ids_i64, [1, input_ids.length])
        });
        const uncondOut = await models.text_encoder.sess.run({
            "input_ids": new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor("int64", uncond_ids_i64, [1, uncond_ids.length])
        });
        ...
        for (let j = 0; j < config.images; j++) {
            ...
            let latents = new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor(
            ...
            for (let i = 0; i < scheduler.timesteps.length; i++) {
                ...
                const tTensor = new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor("float32", new Float32Array([t]), []);
                ...
                const guidedTensor = new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor("float32", guided, [1, 4, 64, 64]);
            ...
            const scaled_latents = new onnxruntime_web_webgpu__WEBPACK_IMPORTED_MODULE_0__["default"].Tensor(
                "float32",
                scaledLatentsData,
                latents.dims
            );
