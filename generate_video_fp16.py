...
text_embeddings = text_embeddings_fp32.astype(np.float16)
uncond_embeddings = uncond_embeddings_fp32.astype(np.float16)
text_embeddings_combined = np.concatenate(
    [uncond_embeddings, text_embeddings], axis=0
).astype(np.float16)  # (2,77,768)
