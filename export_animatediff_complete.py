...
os.makedirs("onnx_models_0", exist_ok=True)
...
with torch.no_grad():
    ...
    torch.onnx.export(
        text_encoder,
        dummy_ids,
        "onnx_models_0/text_encoder.onnx",
        opset_version=17,
...
print(" UNet exported to onnx_models_0/unet_video.onnx")
...
with torch.no_grad():
    ...
    torch.onnx.export(
        vae_wrapper,
        dummy_latent,
        "onnx_models_0/vae_decoder.onnx",
        opset_version=17,
        input_names=["latent"],
        output_names=["image"],
        dynamic_axes={
